...
function Subscribe() {
  return (
    <>
      <NavBar />
      <main className="px-2 max-w-screen-xl mx-auto flex flex-col lg:flex-row lg:items-center gap-6 my-16 text-stone-950">
        <section className="text-center flex flex-col gap-6 items-center lg:flex-1 lg:items-start">
          <h2 className="font-semibold mt-12 md:mt-4 text-4xl capitalize lg:text-5xl lg:text-left">
